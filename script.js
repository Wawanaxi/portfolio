...
function moveImages(hovered) {
  var containerImg = document.querySelector('.container .container_img');
  if (hovered) {
    containerImg.classList.remove('hidden');
    var images = containerImg.querySelectorAll('img');
    images.forEach(function(image) {
      image.style.transform = "translateX(275%)";
    });
  } else {
